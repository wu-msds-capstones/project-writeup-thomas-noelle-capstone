...
```{r}
#| label: figure-7a
#| fig-cap: "**Figure 7a:** Feature importance heatmap across model configurations (all crashes)"
#| fig-align: center
heatmap_all_visual
```
...
```{r}
#| label: figure-7b
#| fig-cap: "**Figure 7b:** Feature importance heatmap across model configurations (bicycle crashes)"
#| fig-align: center
heatmap_bike_visual
```
...
```{r}
#| label: figure-7c
#| fig-cap: "**Figure 7c:** Feature importance heatmap across model configurations (pedestrian crashes)"
#| fig-align: center
heatmap_ped_visual
```
