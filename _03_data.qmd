...
![Relational schema diagram showing normalized structure around `intersections`, with foreign key joins from crashes, bicycle infrastructure, street lights, traffic calming features, traffic volumes, and speed limits.](../figures/schema.pdf)

**Figure 1.** Relational schema for capstone database showing intersection-level joins across datasets.
